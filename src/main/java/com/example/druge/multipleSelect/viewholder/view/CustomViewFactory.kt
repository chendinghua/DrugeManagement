package com.example.druge.multipleSelect.viewholder.view
...
import com.example.druge.multipleSelect.viewholder.AnimationInterface
...
abstract class CustomViewFactory :DecorateFactory, AnimationInterface {
    ...
    override fun decorate(viewHolder: android.support.v7.widget.RecyclerView.ViewHolder, adapter:MultipleAdapter):BaseViewHolder {
