    ...
    private boolean handlerException(Throwable ex) {
        ...
        new Thread() {
            public void run() {
                ...
                param.put("content",msg.toString());
                InteractiveDataUtil.interactiveMessage(mContext,param,new Handler(),MethodEnum.ADDERRORINFO,InteractiveEnum.POST);

                Log.d("2635", "run: "+msg.toString());
